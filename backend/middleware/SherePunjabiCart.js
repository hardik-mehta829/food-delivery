...
const SherePunjabiCartCart = async function (req, res, next) {
  ...
  // next();
  if (!user.selectedRestaurant || user.selectedRestaurant === 'SherePunjabi')
    next();
  else
    res
      .status(400)
...
module.exports = SherePunjabiCartCart;
